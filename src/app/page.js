...
export default function Page() {
  ...
  return (
    <div className="flex flex-col items-center bg-black min-h-screen text-light">
      {/* Main Interface */}
      <header className="text-center py-16 px-4 w-full max-w-screen-lg">
        <h1 className="text-neonPink text-4xl sm:text-6xl font-extrabold glowing-text">
      ...
      <section className="w-full bg-black py-16 px-4">
        <div className="max-w-screen-lg mx-auto text-center">
          <h2 className="text-neonBlue text-3xl sm:text-4xl font-bold glowing-text">
            Features You'll Love
          </h2>
          <p className="text-gray-200 text-base sm:text-lg mt-4 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 justify-center mt-10">
            <div className="p-6 mx-auto max-w-xs bg-black border-2 border-neonPink rounded-lg shadow-neon">
              <h3 className="text-neonPink text-xl sm:text-2xl font-bold">
                Seamless Integration
              </h3>
              <p className="text-gray-300 mt-2 text-sm sm:text-base">
                Connect all your tools effortlessly.
              </p>
            </div>
            <div className="p-6 mx-auto max-w-xs bg-black border-2 border-neonPink rounded-lg shadow-neon">
              <h3 className="text-neonPink text-xl sm:text-2xl font-bold">
